...
output_name = args[1]
pdf(paste(output_name, ".pdf", sep=""),width=12,height=4,useDingbats=FALSE)


par(mfrow=c(1,3))


data<-read.table(paste(output_name,".pmd",sep=""),header= TRUE)
...
title(main = output_name, cex.main = 2, font.main = 1)
